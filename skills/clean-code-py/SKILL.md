...
- Prefer a small, clear parameter list; positional arguments are fine when
  their order and meaning are obvious
- Use keyword-only arguments when they materially improve call-site readability
